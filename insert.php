...
<?php
	...
	echo "</div><br><br>";
	//---<<start 2018/04/27 asanoma ÉNÉåÅ[ÉÄëŒâû
	if($filename == "SYAKENINFO_1")
	{
		echo "<center><b><font color='red'>é‘éÌÇ‚égópé“ÇÃÉ}ÉXÉ^Å[ìoò^ÇÕÇ®çœÇ≈Ç∑Ç©ÅH</font></b></center><br>";
	}
	echo $form;
	echo "</tr></table>";
	...
	if($isMaster == true)
	{
		echo '<input type="submit" name = "back" value = "'.$title1.'ÉÅÉìÉeÉiÉìÉXÇ÷" class="free" onClick ="isCancel = true;">';
	}
	echo "</form>";
	echo "</div>";
?>
